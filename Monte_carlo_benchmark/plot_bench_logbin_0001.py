...
insert1='./bench_data_qed_eta0001/'
gg=np.loadtxt(insert1+'py_0000.txt')
b0=np.loadtxt(insert1+'bz_part_0000.txt')
t0=np.loadtxt(insert1+'t_0000.txt')
gg = gg[0]
...
#plt.ylim(0,1)
plt.text(1e-4*eta**2,0.6,r'$\eta=0.001$',fontdict=font)
...
fig.savefig('./plot_bench_logbin_eta=0001.png',format='png',dpi=160)
#plt.close("all")
