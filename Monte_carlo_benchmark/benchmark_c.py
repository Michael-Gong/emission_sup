...
plt.subplot(1,2,1)
eta = 0.01
chi = np.logspace(np.log10(1e-8*eta**2),np.log10(0.499999999*eta),2000)
y   = 4*chi/(3*eta*(eta-2*chi))
chi_c = np.logspace(np.log10(1e-8*eta**2),np.log10(1e2*eta**2),2000)
y_c = 4*chi_c/(3*eta*eta)
F_chi = np.zeros_like(chi)
F_chi_c = np.zeros_like(chi_c)
for i in range(np.size(chi)):
    result = integrate.quad(lambda x: kv(5./3.,x), y[i], 1e3*y[i])
    F_chi[i] = 4*chi[i]**2/eta**2*y[i]*kv(2./3.,y[i])+(1-2*chi[i]/eta)*y[i]*result[0]
    result = integrate.quad(lambda x: kv(5./3.,x), y_c[i], 1e3*y_c[i])
    F_chi_c[i]=y_c[i]*result[0]
plt.plot(chi, F_chi,   '-k',   linewidth=3, label='$\eta=0.01$')
plt.plot(chi_c, F_chi_c, '--k',  linewidth=3)
eta = 0.1
chi = np.logspace(np.log10(1e-8*eta**2),np.log10(0.499999999*eta),2000)
y   = 4*chi/(3*eta*(eta-2*chi))
chi_c = np.logspace(np.log10(1e-8*eta**2),np.log10(1e2*eta**2),2000)
...
plt.plot(chi_c, F_chi_c, '--b',  linewidth=3)
eta = 1.
chi = np.logspace(np.log10(1e-8*eta**2),np.log10(0.499999999*eta),2000)
y   = 4*chi/(3*eta*(eta-2*chi))
chi_c = np.logspace(np.log10(1e-8*eta**2),np.log10(1e2*eta**2),2000)
...
plt.plot(chi_c, F_chi_c, '--r',  linewidth=3)
...
plt.subplot(1,2,2)
eta = 0.01
chi = np.logspace(np.log10(1e-8*eta),np.log10(0.499999999*eta),200)
y   = 4*chi/(3*eta*(eta-2*chi))
chi_c = np.logspace(np.log10(1e-8*eta),np.log10(1e2*eta),200)
y_c = 4*chi_c/(3*eta*eta)
F_chi = np.zeros_like(chi)
F_chi_c = np.zeros_like(chi_c)
for i in range(np.size(chi)):
...
plt.plot(chi_c, F_chi_c/chi_c, '--k',  linewidth=3)
eta = 0.1
chi = np.logspace(np.log10(1e-8*eta),np.log10(0.499999999*eta),200)
y   = 4*chi/(3*eta*(eta-2*chi))
chi_c = np.logspace(np.log10(1e-8*eta),np.log10(1e2*eta),200)
...
plt.plot(chi_c, F_chi_c/chi_c, '--b',  linewidth=3)
eta = 1.
chi = np.logspace(np.log10(1e-8*eta),np.log10(0.499999999*eta),200)
y   = 4*chi/(3*eta*(eta-2*chi))
chi_c = np.logspace(np.log10(1e-8*eta),np.log10(1e2*eta),200)
...
plt.plot(chi_c, F_chi_c/chi_c, '--r',  linewidth=3)
...
fig.savefig('./bench_eta_c.png',format='png',dpi=160)
#plt.close("all")
