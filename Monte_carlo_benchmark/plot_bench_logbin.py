...
eta = g0*b0/4.1e5
#eta = 0.1
chi = np.logspace(np.log10(1e-5*eta**2),np.log10(0.49*eta),2000)
...
#plt.ylim(0,1)
plt.text(1e-4*eta**2,0.6,r'$\eta=1.0$',fontdict=font)
...
fig.savefig('./plot_bench_logbin_eta=1.png',format='png',dpi=160)
#plt.close("all")
