...
data = np.loadtxt('./data_log/photon_1000.0.txt')
...
n, bins, patches = plt.hist(data, bins=np.linspace(0.1,250,250), facecolor='blue', alpha=0.75)
...
fig.savefig('./hist_spectrum_log.png',format='png',dpi=160)
plt.close("all")
