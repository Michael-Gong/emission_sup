...
insert1='./qe_90_full/'
px=0.0 # np.loadtxt(insert1+'px_0000.txt')
py=100.0 #np.loadtxt(insert1+'py_0000.txt')
gg=(px**2+py**2+1)**0.5
b0=10.0 #np.loadtxt(insert1+'bz_part_0000.txt')
t0=10.472626*6 #np.loadtxt(insert1+'t_0000.txt')
insert_n='_0000'
...
fig.savefig(to_path+'wrap_in90_full.png',format='png',dpi=160)
