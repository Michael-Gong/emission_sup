...
plt.plot(grid_omega_x,theory_line,'--k',linewidth=3)
#plt.plot(xx, yy0*norm_fac2, linestyle='-',color='tomato',linewidth=3,label=r'$\theta_d=89.991^\circ$')
#plt.plot(xx, yy5*norm_fac2, linestyle='-',color='orange',linewidth=3,label=r'$\theta_d=89.91^\circ$')
#plt.plot(xx, yy6*norm_fac2, linestyle='-',color='mediumseagreen',linewidth=3,label=r'$\theta_d=89.1^\circ$')
plt.plot(xx, yy7*norm_fac2, linestyle='-',color='royalblue',linewidth=3,label=r'$\theta_d=81.0^\circ$')
...
plt.subplots_adjust(left=0.15, bottom=0.12, right=0.98, top=0.98, wspace=0.1, hspace=None) 
fig = plt.gcf()
fig.set_size_inches(9.5, 9.0)
fig.savefig(to_path+'wrap_full_con_insert.png',format='png',dpi=160)
