...
insert1='./'
px=np.loadtxt(insert1+'px_0000.txt')
py=np.loadtxt(insert1+'py_0000.txt')
gg=(px**2+py**2+1)**0.5
...
from_path = '../Data_a100_p100_compare/'
...
plt.plot(grid_omega_x, data_omega[:,i_theta,i_phi], '-', color='blue', linewidth=5.5, label='numerical calculation')
...
plt.subplots_adjust(top=0.98, bottom=0.08, left=0.10, right=0.98, hspace=0.2, wspace=0.2)
fig = plt.gcf()
fig.set_size_inches(12.7, 12.2)
#fig.set_size_inches(5, 4.5)
fig.savefig('./plot_.png',format='png',dpi=160)
plt.close("all")
