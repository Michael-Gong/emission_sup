...
plt.plot(grid_omega_x, data_omega[:,0,0],linestyle='-',color='crimson',linewidth=3,label=r'$\theta_d=90.00^\circ$')
plt.plot(grid_omega_x, data_omega[:,0,2],linestyle='-',color='darkorange',linewidth=3,label=r'$\theta_d=90.09^\circ$')
plt.plot(grid_omega_x, data_omega[:,0,3],linestyle='-',color='mediumseagreen',linewidth=3,label=r'$\theta_d=90.9^\circ$')
plt.plot(grid_omega_x, data_omega[:,0,4],linestyle='-',color='royalblue',linewidth=3,label=r'$\theta_d=99.0^\circ$')
...
plt.plot(grid_omega_x,theory_line,'--k',linewidth=3,label='Synchrotron radiation')
plt.plot(grid_omega_x, data_omega[:,0,0],linestyle='-',color='crimson',linewidth=3,label=r'$\theta_d=90.00^\circ$')
plt.plot(grid_omega_x, data_omega[:,0,6],linestyle='-',color='darkorange',linewidth=3,label=r'$\theta_d=89.81^\circ$')
plt.plot(grid_omega_x, data_omega[:,0,7],linestyle='-',color='mediumseagreen',linewidth=3,label=r'$\theta_d=89.1^\circ$')
plt.xlabel('$\omega$ [$\omega_0$]',fontdict=font)
plt.ylabel(r'$\frac{dI^2}{d\omega d\Omega}$'+' [$m_ec^2/\omega_0$]',fontdict=font)
plt.xticks(fontsize=font_size); 
plt.yticks(fontsize=font_size);
...
plt.subplot(2,2,4)
plt.plot(grid_omega_x,theory_line,'--k',linewidth=3,label='Synchrotron radiation')
plt.plot(grid_omega_x, data_omega[:,0,8],linestyle='-',color='royalblue',linewidth=3,label=r'$\theta_d=81.0^\circ$')
plt.xlabel('$\omega$ [$\omega_0$]',fontdict=font)
#plt.ylabel(r'$\frac{dI^2}{d\omega d\Omega}$'+' [$m_ec^2/\omega_0$]',fontdict=font)
plt.xticks(fontsize=font_size); 
plt.yticks(fontsize=font_size);
...
fig.savefig(to_path+'wrap_full_grad.png',format='png',dpi=160)
