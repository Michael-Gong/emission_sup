...
plt.plot(grid_omega_x, data_omega[:,0,0],linestyle='-',color='crimson',linewidth=3,label=r'$\theta_d=90.000^\circ$')
plt.plot(grid_omega_x, data_omega[:,0,2],linestyle='-',color='darkorange',linewidth=3,label=r'$\theta_d=90.090^\circ$')
plt.plot(grid_omega_x, data_omega[:,0,3],linestyle='-',color='mediumseagreen',linewidth=3,label=r'$\theta_d=90.900^\circ$')
plt.plot(grid_omega_x, data_omega[:,0,4],linestyle='-',color='royalblue',linewidth=3,label=r'$\theta_d=99.000^\circ$')
...
#plt.plot(grid_omega_x, data_omega[:,0,6], '-k',marker='o',linewidth=2)
plt.plot(grid_omega_x,theory_line,'--k',linewidth=3,label='Synchrotron radiation')
plt.plot(grid_omega_x, data_omega[:,0,8],linestyle='-',color='royalblue',linewidth=3,label=r'$\theta_d=81.000^\circ$')
plt.plot(grid_omega_x, data_omega[:,0,7],linestyle='-',color='mediumseagreen',linewidth=3,label=r'$\theta_d=89.100^\circ$')
plt.plot(grid_omega_x, data_omega[:,0,6],linestyle='-',color='darkorange',linewidth=3,label=r'$\theta_d=89.910^\circ$')
plt.plot(grid_omega_x, data_omega[:,0,0],linestyle='-',color='crimson',linewidth=3,label=r'$\theta_d=90.000^\circ$')
#plt.plot(xx, yy0*norm_fac2, linestyle='-',color='crimson',linewidth=3,label=r'$\theta_d=90.00^\circ$')
...
plt.subplot(1,3,3)
insert1='./qe_90_grad/'
px=0 # np.loadtxt(insert1+'px_0000.txt')
py=100 #np.loadtxt(insert1+'py_0000.txt')
p0=(px**2+py**2)**0.5
gg=(px**2+py**2+1)**0.5
alpha=10.0
b0=2*(alpha*p0*(1-np.cos(90.0/180.0*np.pi)))**0.5*1 #0.1 is for ratio
insert2='./in_90_grad/'
...
print(to_t)
to_t_2=to_t[(to_theta>-91)&(to_theta<-89)]
print(to_t_2)
...
photon_px=photon_px[(photon_theta>-91)&(photon_theta<-89)]
photon_py=photon_py[(photon_theta>-91)&(photon_theta<-89)]
photon = (photon_px**2+photon_py**2)**0.5
chi   = photon*b0/2.0/4.1e5
eta   = gg*b0/4.1e5
dt    = t0/6.28
...
for i in range(np.size(grid_x)):
    ...
    grid_y[i] = grid_y[i]*(2*xi[i]*gg*3**0.5/(4*pi**2)*kv(0.66666666666667,xi[i])**2)/result[0]
#plt.bar(grid_x, grid_y, width=0.3*grid_x, color='blue',alpha=0.5,edgecolor='black',linewidth=2,label='Monte-carlo method')
plt.plot(grid_x,grid_y,marker='o',markerfacecolor='tomato',markeredgecolor='darkred',markersize=10,markeredgewidth=3,label=r'$\theta_d=90.000^\circ$',linestyle='None')

print(to_t)
to_t_2=to_t[(to_theta>-82)&(to_theta<-80)]
print(to_t_2)
t0=(to_t_2[-1]-to_t_2[0])*2.0 #14.11078 #np.loadtxt(insert1+'t_0000.txt')
insert_n='_0000'
photon_px=np.loadtxt(insert1+'photon_px'+insert_n+'.txt')
photon_py=np.loadtxt(insert1+'photon_py'+insert_n+'.txt')
photon_theta=np.arctan2(photon_py,photon_px)/np.pi*180.
photon_px=photon_px[(photon_theta>-82)&(photon_theta<-80)]
photon_py=photon_py[(photon_theta>-82)&(photon_theta<-80)]
photon = (photon_px**2+photon_py**2)**0.5
chi   = photon*b0/2.0/4.1e5
eta   = gg*b0/4.1e5
dt    = t0/6.28
...
for i in range(np.size(grid_x)):
    ...
    grid_y[i] = grid_y[i]*(2*xi[i]*gg*3**0.5/(4*pi**2)*kv(0.66666666666667,xi[i])**2)/result[0]
#plt.bar(grid_x, grid_y, width=0.3*grid_x, color='blue',alpha=0.5,edgecolor='black',linewidth=2,label='Monte-carlo method')
plt.plot(grid_x,grid_y,marker='o',markerfacecolor='skyblue',markeredgecolor='darkblue',markersize=10,markeredgewidth=3,label=r'$\theta_d=81.000^\circ$',linestyle='None')

print(to_t)
to_t_2=to_t[(to_theta>-61)&(to_theta<-59)]
print(to_t_2)
t0=(to_t_2[-1]-to_t_2[0])*2.0 #14.11078 #np.loadtxt(insert1+'t_0000.txt')
insert_n='_0000'
photon_px=np.loadtxt(insert1+'photon_px'+insert_n+'.txt')
photon_py=np.loadtxt(insert1+'photon_py'+insert_n+'.txt')
photon_theta=np.arctan2(photon_py,photon_px)/np.pi*180.
photon_px=photon_px[(photon_theta>-61)&(photon_theta<-59)]
photon_py=photon_py[(photon_theta>-61)&(photon_theta<-59)]
photon = (photon_px**2+photon_py**2)**0.5
chi   = photon*b0/2.0/4.1e5
eta   = gg*b0/4.1e5
dt    = t0/6.28
...
for i in range(np.size(grid_x)):
    ...
    grid_y[i] = grid_y[i]*(2*xi[i]*gg*3**0.5/(4*pi**2)*kv(0.66666666666667,xi[i])**2)/result[0]
#plt.bar(grid_x, grid_y, width=0.3*grid_x, color='blue',alpha=0.5,edgecolor='black',linewidth=2,label='Monte-carlo method')
plt.plot(grid_x,grid_y,marker='o',markerfacecolor='yellow',markeredgecolor='darkorange',markersize=10,markeredgewidth=3,label=r'$\theta_d=60.000^\circ$',linestyle='None')
...
fig.savefig(to_path+'wrap_grad_in90.png',format='png',dpi=160)
